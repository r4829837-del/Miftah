...
import { Settings as SettingsIcon, Bell, Lock, User, School, GraduationCap, Users, ToggleLeft, ToggleRight, Calendar, Clock, Save, Check, Download, Upload, AlertTriangle, Database } from 'lucide-react';
