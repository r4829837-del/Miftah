          ...
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
                ...
                <li>اضغط على زر "إضافة تلميذ جديد"</li>
      ...
      content: (
        <div className="space-y-6" dir="rtl">
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
            <h3 className="text-xl font-bold text-purple-800 mb-4">مستويات الكلية</h3>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="bg-white border border-purple-200 rounded p-3 text-center">
                <div className="font-bold text-purple-800">1AM</div>
                <div className="text-sm text-gray-600">السنة الأولى متوسط</div>
              </div>
              <div className="bg-white border border-purple-200 rounded p-3 text-center">
                <div className="font-bold text-purple-800">2AM</div>
                <div className="text-sm text-gray-600">السنة الثانية متوسط</div>
              </div>
              <div className="bg-white border border-purple-200 rounded p-3 text-center">
                <div className="font-bold text-purple-800">3AM</div>
